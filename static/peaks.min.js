...
"use strict";module.exports={arraybuffer:require("./arraybuffer.js"),object:require("./object.js")};
...
"use strict";var WaveformData=require("../core.js");module.exports=function(e,t){var a=e.scale,r=e.scale_adjuster;return function(e){var n,s,f=Math.floor(e.length/a),o=20,l=new DataView(new ArrayBuffer(o+2*f)),u=1/0,v=-(1/0),h=a,c=e.length;l.setInt32(0,1,!0),l.setUint32(4,1,!0),l.setInt32(8,e.sampleRate,!0),l.setInt32(12,a,!0),l.setInt32(16,f,!0),n=e.getChannelData(0),s=e.getChannelData(0);for(var i=0;i<c;i++){var D=(n[i]+s[i])/2*r;D<u&&(u=D,u<-128&&(u=-128)),D>v&&(v=D,v>127&&(v=127)),0===--h&&(l.setInt8(o++,Math.floor(u)),l.setInt8(o++,Math.floor(v)),u=1/0,v=-(1/0),h=a)}t(new WaveformData(l.buffer,WaveformData.adapters.arraybuffer),e)}};
},{"../core.js":9}],8:[function(require,module,exports){
"use strict";function fromAudioObjectBuilder(e,o,t){var u={scale:512,scale_adjuster:127};"function"==typeof o?(t=o,o={}):o=o||{},o.scale=o.scale||u.scale,o.scale_adjuster=o.scale_adjuster||u.scale_adjuster,audioContext.decodeAudioData(e,audioDecoder(o,t))}var audioContext=require("audio-context"),audioDecoder=require("./audiodecoder.js");fromAudioObjectBuilder.getAudioContext=function(){return audioContext},module.exports=fromAudioObjectBuilder;
},{"./audiodecoder.js":7,"audio-context":12}],9:[function(require,module,exports){
"use strict";var WaveformDataSegment=require("./segment.js"),WaveformDataPoint=require("./point.js"),WaveformData=module.exports=function(t,e){this.adapter=e.fromResponseData(t),this.segments={},this.points={},this.offset(0,this.adapter.length)};WaveformData.create=function(t){var e=null,n=null;if(t&&"object"==typeof t&&("responseText"in t||"response"in t)&&(n="responseType"in t?t.response:t.responseText||t.response),Object.keys(WaveformData.adapters).some(function(a){if(WaveformData.adapters[a].isCompatible(n||t))return e=WaveformData.adapters[a],!0}),null===e)throw new TypeError("Could not detect a WaveformData adapter from the input.");return new WaveformData(n||t,e)},WaveformData.prototype={offset:function(t,e){var n=this.adapter.length;if(e<0)throw new RangeError("End point must be non-negative ["+Number(e)+" < 0]");if(e<=t)throw new RangeError("We can't end prior to the starting point ["+Number(e)+" <= "+Number(t)+"]");if(t<0)throw new RangeError("Start point must be non-negative ["+Number(t)+" < 0]");if(t>=n)throw new RangeError("Start point must be within range ["+Number(t)+" >= "+n+"]");e>n&&(e=n),this.offset_start=t,this.offset_end=e,this.offset_length=e-t},set_segment:function(t,e,n){return n=n||"default",this.segments[n]=new WaveformDataSegment(this,t,e),this.segments[n]},set_point:function(t,e){return void 0!==e&&null!==e&&0!==e.length||(e="default"),this.points[e]=new WaveformDataPoint(this,t),this.points[e]},remove_point:function(t){this.points[t]&&delete this.points[t]},resample:function(t){"number"==typeof t&&(t={width:t}),t.input_index="number"==typeof t.input_index?t.input_index:null,t.output_index="number"==typeof t.output_index?t.output_index:null,t.scale="number"==typeof t.scale?t.scale:null,t.width="number"==typeof t.width?t.width:null;var e=Boolean(t.input_index)||Boolean(t.output_index);if(null!==t.input_index&&t.input_index>=0==!1)throw new RangeError("options.input_index should be a positive integer value. ["+t.input_index+"]");if(null!==t.output_index&&t.output_index>=0==!1)throw new RangeError("options.output_index should be a positive integer value. ["+t.output_index+"]");if(null!==t.width&&t.width>0==!1)throw new RangeError("options.width should be a strictly positive integer value. ["+t.width+"]");if(null!==t.scale&&t.scale>0==!1)throw new RangeError("options.scale should be a strictly positive integer value. ["+t.scale+"]");if(!t.scale&&!t.width)throw new RangeError("You should provide either a resampling scale or a width in pixel the data should fit in.");var n=["width","scale","output_index","input_index"].reduce(function(e,n){return e+(null===t[n]?0:1)},0);if(e&&4!==n)throw new Error("Some partial resampling options are missing. You provided "+n+" of them over 4.");var a=[],r=t.scale||Math.floor(this.duration*this.adapter.sample_rate/t.width),i=this.adapter.scale,o=2,s=this.adapter.length,u=t.input_index||0,p=t.output_index||0,h=s?this.min_sample(u):0,l=s?this.max_sample(u):0,f=-128,d=127;if(r<i)throw new Error("Zoom level "+r+" too low, minimum: "+i);for(var m,c,_,g,w,v=function(t){return Math.floor(t*r)},b=function(t,e){a.push(t,e)};u<s;){for(;Math.floor(v(p)/i)<=u;)p&&b(h,l),w=u,p++,m=v(p),c=v(p-1),m!==c&&(h=d,l=f);for(m=v(p),_=Math.floor(m/i),_>s&&(_=s);u<_;)g=this.min_sample(u),g<h&&(h=g),g=this.max_sample(u),g>l&&(l=g),u++;if(e&&a.length/o>=t.width)break}return e?a.length/o>t.width&&u!==w&&b(h,l):u!==w&&b(h,l),new WaveformData({version:this.adapter.version,samples_per_pixel:r,length:a.length/o,data:a,sample_rate:this.adapter.sample_rate},WaveformData.adapters.object)},get min(){return this.offsetValues(this.offset_start,this.offset_length,0)},get max(){return this.offsetValues(this.offset_start,this.offset_length,1)},offsetValues:function(t,e,n){var a=this.adapter,r=[];n+=2*t;for(var i=0;i<e;i++)r.push(a.at(2*i+n));return r},get duration(){return this.adapter.length*this.adapter.scale/this.adapter.sample_rate},get offset_duration(){return this.offset_length*this.adapter.scale/this.adapter.sample_rate},get pixels_per_second(){return this.adapter.sample_rate/this.adapter.scale},get seconds_per_pixel(){return this.adapter.scale/this.adapter.sample_rate},at:function(t){return this.adapter.at(t)},at_time:function(t){return Math.floor(t*this.adapter.sample_rate/this.adapter.scale)},time:function(t){return t*this.seconds_per_pixel},in_offset:function(t){return t>=this.offset_start&&t<this.offset_end},min_sample:function(t){return this.adapter.at(2*t)},max_sample:function(t){return this.adapter.at(2*t+1)}},WaveformData.adapters={},WaveformData.adapter=function(t){this.data=t};
...
var window=require("global/window"),Context=window.AudioContext||window.webkitAudioContext;Context&&(module.exports=new Context);
...
"use strict";var WaveformData=require("./lib/core");WaveformData.adapters=require("./lib/adapters"),WaveformData.builders={webaudio:require("./lib/builders/webaudio.js")},module.exports=WaveformData;
},{"./lib/adapters":5,"./lib/builders/webaudio.js":8,"./lib/core":9}],15:[function(require,module,exports){
function Peaks(e){ee.call(this,{wildcard:!0}),this.options={zoomLevels:[512,1024,2048,4096],dataUri:null,dataUriDefaultFormat:"json",logger:null,keyboard:!1,nudgeIncrement:.01,inMarkerColor:"#a0a0a0",outMarkerColor:"#a0a0a0",zoomWaveformColor:"rgba(0, 225, 128, 1)",overviewWaveformColor:"rgba(0,0,0,0.2)",overviewHighlightRectangleColor:"grey",randomizeSegmentColor:!0,height:200,segmentColor:"rgba(255, 161, 39, 1)",playheadColor:"rgba(0, 0, 0, 1)",playheadTextColor:"#aaa",axisGridlineColor:"#ccc",axisLabelColor:"#aaa",template:['<div class="waveform">','<div class="zoom-container"></div>','<div class="overview-container"></div>',"</div>"].join(""),pointMarkerColor:"#FF0000",pointDblClickHandler:null,pointDragEndHandler:null,waveformBuilderOptions:{scale:512,scale_adjuster:127},zoomAdapter:"animated"},this.container=e,this.currentZoomLevel=0,this.logger=console.error.bind(console)}var EventEmitter=require("EventEmitter"),AudioPlayer=require("peaks/player/player"),Waveform=require("peaks/waveform/waveform.core"),mixins=require("peaks/waveform/waveform.mixins"),keyboard=require("peaks/player/player.keyboard"),buildUi=function(e){return{player:e.querySelector(".waveform"),zoom:e.querySelector(".zoom-container"),overview:e.querySelector(".overview-container")}},extend=function(e,o){for(var t in o)e[t]=o[t];return e},ee=EventEmitter.EventEmitter2||EventEmitter;Peaks.init=function(e){if(e=e||{},e.audioElement&&(e.mediaElement=e.audioElement,console&&"function"==typeof console.log&&console.log("[Peaks.init] `audioElement` option is deprecated. Please use `mediaElement` instead.")),!e.mediaElement)throw new Error("[Peaks.init] Please provide an audio element.");if(!(e.mediaElement instanceof HTMLMediaElement))throw new TypeError("[Peaks.init] The mediaElement option should be an HTMLMediaElement.");if(!e.container)throw new Error("[Peaks.init] Please provide a container object.");if(e.container.clientWidth>0==!1)throw new TypeError("[Peaks.init] Please ensure that the container has a width.");if(e.logger&&"function"!=typeof e.logger)throw new TypeError("[Peaks.init] The `logger` option should be a function.");var o=new Peaks(e.container);if(extend(o.options,e),extend(o.options,{segmentInMarker:mixins.defaultInMarker(o.options),segmentOutMarker:mixins.defaultOutMarker(o.options),segmentLabelDraw:mixins.defaultSegmentLabelDraw(o.options),pointMarker:mixins.defaultPointMarker(o.options)}),e.logger&&(o.logger=e.logger),o.on("error",o.logger.bind(null)),"string"==typeof o.options.template)o.container.innerHTML=o.options.template;else{if(!(o.options.template instanceof HTMLElement))throw new TypeError("Please ensure you provide an HTML string or a DOM template as `template` instance option. Provided: "+o.options.template);o.container.appendChild(o.options.template)}return o.options.keyboard&&keyboard.init(o),o.player=new AudioPlayer(o),o.player.init(o.options.mediaElement),o.waveform=new Waveform(o),o.waveform.init(buildUi(o.container)),o.seeking=!1,o.on("waveformOverviewReady",function(){o.waveform.openZoomView(),o.options.segments&&o.segments.addSegment(o.options.segments),o.options.points&&o.points.addPoint(o.options.points)}),o},Peaks.prototype=Object.create(ee.prototype,{segments:{get:function(){function e(e,t,n,r,i){var a=arguments[0];if("number"==typeof a&&(a=[{startTime:e,endTime:t,editable:n,color:r,labelText:i}]),!Array.isArray(a))throw new TypeError("[Peaks.segments.addSegment] Unrecognized segment parameters.");a.forEach(function(e){o.waveform.segments.createSegment(e.startTime,e.endTime,e.editable,e.color,e.labelText)}),o.waveform.segments.render()}var o=this;return{addSegment:e,add:e,remove:function(e){var t=o.waveform.segments.remove(e);if(null===t)throw new RangeError("Unable to find the requested segment"+String(e));return o.waveform.segments.updateSegments(),o.waveform.segments.segments.splice(t,1).pop()},removeByTime:function(e,t){t="number"==typeof t?t:0;var n;n=t>0?function(o){return o.startTime===e&&o.endTime===t}:function(o){return o.startTime===e};var r=o.waveform.segments.segments.filter(n).map(function(e,t){return o.waveform.segments.remove(e),t}).sort(function(e,o){return o-e}).map(function(e){return o.waveform.segments.segments.splice(e,1),e});return o.waveform.segments.updateSegments(),r.length},removeAll:function(){o.waveform.segments.removeAll()},getSegments:function(){return o.waveform.segments.segments}}}},points:{get:function(){var e=this;return{add:function(o,t,n,r){var i=arguments[0];if("number"==typeof i&&(i=[{timestamp:o,editable:t,color:n,labelText:r}]),!Array.isArray(i))throw new TypeError("[Peaks.points.addPoint] Unrecognized point parameters.");i.forEach(e.waveform.points.createPoint.bind(e.waveform.points)),e.waveform.points.render()},getPoints:function(){return e.waveform.points.points},removeByTime:function(o){var t=e.waveform.points.points.filter(function(e){return e.timestamp===o}).map(function(o,t){return e.waveform.points.remove(o),t}).sort(function(e,o){return o-e}).map(function(o){return e.waveform.points.points.splice(o,1),o});return e.waveform.points.render(),t.length},removeAll:function(){e.waveform.points.removeAll()}}}},time:{get:function(){var e=this;return{setCurrentTime:function(o){return e.player.seekBySeconds(o)},getCurrentTime:function(){return e.player.getTime()}}}},zoom:{get:function(){var e=this;return{zoomIn:function(){e.zoom.setZoom(e.currentZoomLevel-1)},zoomOut:function(){e.zoom.setZoom(e.currentZoomLevel+1)},setZoom:function(o){o>=e.options.zoomLevels.length&&(o=e.options.zoomLevels.length-1),o<0&&(o=0);var t=e.currentZoomLevel;e.currentZoomLevel=o,e.emit("zoom.update",e.options.zoomLevels[o],e.options.zoomLevels[t])},getZoom:function(){return e.currentZoomLevel},overview:function(){e.emit("zoom.update",e.waveform.waveformOverview.data.adapter.scale,e.options.zoomLevels[e.currentZoomLevel])},reset:function(){e.emit("zoom.update",e.options.zoomLevels[e.currentZoomLevel],e.waveform.waveformOverview.data.adapter.scale)}}}}}),module.exports=Peaks;
...
"use strict";function BaseShape(){}function noop(){}function throwUndefined(){throw new Error("You should extend this method in your parent class.")}BaseShape.prototype={createShape:throwUndefined,update:noop},module.exports=BaseShape;
},{}],17:[function(require,module,exports){
var BaseShape=require("peaks/markers/shapes/base"),mixins=require("peaks/waveform/waveform.mixins"),Konva=require("konva"),WaveShape=Object.create(BaseShape.prototype);WaveShape.createShape=function(e,a){var r=new Konva.Shape({fill:e.color,strokeWidth:0,opacity:1});return r.sceneFunc(WaveShape.drawFunc.bind(r,a,e.id)),r},WaveShape.drawFunc=function(e,a,r){var t=e.data;if(void 0!==t.segments[a]){var i=t.segments[a],s=i.offset_length,n=i.offset_start-t.offset_start,o=mixins.interpolateHeight(e.height);mixins.drawWaveform(r,i.min,i.max,n,s,o),r.fillStrokeShape(this)}},module.exports=WaveShape;
},{"konva":3,"peaks/markers/shapes/base":16,"peaks/waveform/waveform.mixins":28}],18:[function(require,module,exports){
var mixins=require("peaks/waveform/waveform.mixins"),Konva=require("konva");module.exports=function(e){function o(o){var i=new Konva.Group,n=new Konva.Group,m=[i,n];return o.editable=Boolean(o.editable),m.forEach(function(i,a){var n=r.views[a];o.editable&&(i.marker=new e.options.pointMarker((!0),i,o,t,e.options.pointDblClickHandler,e.options.pointDragEndHandler),i.add(i.marker)),n.pointLayer.add(i)}),o.zoom=i,o.zoom.view=a.waveformZoomView,o.overview=n,o.overview.view=a.waveformOverview,o}function i(e){a.waveformOverview.data.set_point(a.waveformOverview.data.at_time(e.timestamp),e.id),a.waveformZoomView.data.set_point(a.waveformZoomView.data.at_time(e.timestamp),e.id);var o=a.waveformOverview.data.at_time(e.timestamp);e.editable&&(e.overview.marker&&e.overview.marker.show().setX(o-e.overview.marker.getWidth()),e.overview.marker.label.setText(mixins.niceTime(e.timestamp,!1)));var i=a.waveformZoomView.data.at_time(e.timestamp),t=a.waveformZoomView.frameOffset;if(i<t&&(zoomStartOffset=t),a.waveformZoomView.data.points[e.id].visible){var r=i-t;e.zoom.show(),e.editable&&(e.zoom.marker&&e.zoom.marker.show().setX(r-e.zoom.marker.getWidth()),e.zoom.marker.label.setText(mixins.niceTime(e.timestamp,!1)))}else e.zoom.hide()}function t(e,o){if(e.marker.getX()>0){var t=e.view.frameOffset+e.marker.getX()+e.marker.getWidth();o.timestamp=e.view.data.time(t)}i(o),r.render()}var r=this,a=e.waveform;r.points=[],r.views=[a.waveformZoomView,a.waveformOverview].map(function(e){return e.pointLayer||(e.pointLayer=new Konva.Layer,e.stage.add(e.pointLayer),e.pointLayer.moveToTop()),e}),this.init=function(){e.on("waveform_zoom_displaying",r.updatePoints.bind(r)),e.emit("points.ready")},this.updatePoints=function(){r.points.forEach(i),r.render()},this.createPoint=function(e){if(e.timestamp>=0==!1)throw new RangeError("[waveform.points.createPoint] timestamp should be a >=0 value");e.id="point"+r.points.length,e=o(e),i(e),r.points.push(e)},this.remove=function(e){var o=null;return this.points.some(function(i,t){if(i===e)return o=t,!0}),"number"==typeof o&&(e.overview.destroy(),e.zoom.destroy()),o},this.removeAll=function(){this.views.forEach(function(e){e.pointLayer.removeChildren()}),this.points=[],this.render()},this.render=function(){r.views.forEach(function(e){e.pointLayer.draw()})}};
},{"konva":3,"peaks/waveform/waveform.mixins":28}],19:[function(require,module,exports){
var Konva=require("konva"),mixins=require("peaks/waveform/waveform.mixins"),SegmentShape=require("peaks/markers/shapes/wave");module.exports=function(e){var r=this;r.segments=[],r.views=[e.waveform.waveformZoomView,e.waveform.waveformOverview].map(function(e){return e.segmentLayer||(e.segmentLayer=new Konva.Layer,e.stage.add(e.segmentLayer),e.segmentLayer.moveToTop()),e});var a=function(a,t,m,n,v,s){var w={id:a,startTime:t,endTime:m,labelText:s||"",color:v||i(),editable:n},f=new Konva.Group,d=new Konva.Group,h=[f,d],u=function(e){this.parent.label.show(),this.parent.view.segmentLayer.draw()},g=function(e){this.parent.label.hide(),this.parent.view.segmentLayer.draw()};return h.forEach(function(a,t){var i=r.views[t];if(a.waveformShape=SegmentShape.createShape(w,i),a.waveformShape.on("mouseenter",u),a.waveformShape.on("mouseleave",g),a.add(a.waveformShape),a.label=new e.options.segmentLabelDraw(a,w),a.add(a.label.hide()),n){var m=!0;a.inMarker=new e.options.segmentInMarker(m,a,w,o),a.add(a.inMarker),a.outMarker=new e.options.segmentOutMarker(m,a,w,o),a.add(a.outMarker)}i.segmentLayer.add(a)}),w.zoom=f,w.zoom.view=e.waveform.waveformZoomView,w.overview=d,w.overview.view=e.waveform.waveformOverview,w},t=function(r){e.waveform.waveformOverview.data.set_segment(e.waveform.waveformOverview.data.at_time(r.startTime),e.waveform.waveformOverview.data.at_time(r.endTime),r.id),e.waveform.waveformZoomView.data.set_segment(e.waveform.waveformZoomView.data.at_time(r.startTime),e.waveform.waveformZoomView.data.at_time(r.endTime),r.id);var a=e.waveform.waveformOverview.data.at_time(r.startTime),t=e.waveform.waveformOverview.data.at_time(r.endTime);r.overview.setWidth(t-a),r.editable&&(r.overview.inMarker&&r.overview.inMarker.show().setX(a-r.overview.inMarker.getWidth()),r.overview.outMarker&&r.overview.outMarker.show().setX(t),r.overview.inMarker.label.setText(mixins.niceTime(r.startTime,!1)),r.overview.outMarker.label.setText(mixins.niceTime(r.endTime,!1))),SegmentShape.update.call(r.overview.waveformShape,e.waveform.waveformOverview,r.id);var o=e.waveform.waveformZoomView.data.at_time(r.startTime),i=e.waveform.waveformZoomView.data.at_time(r.endTime),m=e.waveform.waveformZoomView.frameOffset,n=e.waveform.waveformZoomView.frameOffset+e.waveform.waveformZoomView.width;if(o<m&&(o=m),i>n&&(i=n),e.waveform.waveformZoomView.data.segments[r.id].visible){var v=o-m,s=i-m;r.zoom.show(),r.editable&&(r.zoom.inMarker&&r.zoom.inMarker.show().setX(v-r.zoom.inMarker.getWidth()),r.zoom.outMarker&&r.zoom.outMarker.show().setX(s),r.zoom.inMarker.label.setText(mixins.niceTime(r.startTime,!1)),r.zoom.outMarker.label.setText(mixins.niceTime(r.endTime,!1))),SegmentShape.update.call(r.zoom.waveformShape,e.waveform.waveformZoomView,r.id)}else r.zoom.hide()},o=function(r,a){if(r.inMarker.getX()>0){var o=r.view.frameOffset+r.inMarker.getX()+r.inMarker.getWidth();a.startTime=r.view.data.time(o)}if(r.outMarker.getX()<r.view.width){var i=r.view.frameOffset+r.outMarker.getX();a.endTime=r.view.data.time(i)}e.emit("segments.dragged",a),t(a),this.render()}.bind(this),i=function(){var r;if(e.options.randomizeSegmentColor){var a=function(){return Math.floor(255*Math.random())};r="rgba("+a()+", "+a()+", "+a()+", 1)"}else r=e.options.segmentColor;return r};this.init=function(){e.on("waveform_zoom_displaying",this.updateSegments.bind(this)),e.emit("segments.ready")},this.updateSegments=function(){this.segments.forEach(t),this.render()},this.createSegment=function(e,o,i,m,n){var v="segment"+r.segments.length;if(e>=0==!1)throw new TypeError("[waveform.segments.createSegment] startTime should be a positive value");if(o>0==!1)throw new TypeError("[waveform.segments.createSegment] endTime should be a positive value");if(o>e==!1)throw new RangeError("[waveform.segments.createSegment] endTime should be higher than startTime");var s=a(v,e,o,i,m,n);return t(s),r.segments.push(s),s},this.remove=function(e){var r=null;return this.segments.some(function(a,t){if(a===e)return r=t,!0}),"number"==typeof r&&(e=this.segments[r],e.overview.destroy(),e.zoom.destroy()),r},this.removeAll=function(){this.views.forEach(function(e){e.segmentLayer.removeChildren()}),this.segments=[],this.render()},this.render=function(){this.views.forEach(function(e){e.segmentLayer.draw()})}};
},{"konva":3,"peaks/markers/shapes/wave":17,"peaks/waveform/waveform.mixins":28}],20:[function(require,module,exports){
var mixins=require("peaks/waveform/waveform.mixins"),radio=function(e){function t(e,t){return e*(t/100)}return{init:function(t){var i=this;this.mediaElement=t,this.duration=this.mediaElement.duration,4===this.mediaElement.readyState&&e.emit("player_load",i),this.mediaElement.addEventListener("timeupdate",function(){e.emit("player_time_update",i.getTime())}),this.mediaElement.addEventListener("play",function(){e.emit("player_play",i.getTime())}),this.mediaElement.addEventListener("pause",function(){e.emit("player_pause",i.getTime())}),this.mediaElement.addEventListener("seeked",function(){e.emit("player_seek",i.getTime())})},setSource:function(e){this.mediaElement.setAttribute("src",e)},getSource:function(){return this.mediaElement.src},play:function(){this.mediaElement.play(),e.emit("radio_play",this.getTime())},pause:function(){this.mediaElement.pause(),e.emit("radio_pause",this.getTime())},getTime:function(){return this.mediaElement.currentTime},getTimeFromPercentage:function(e){return mixins.niceTime(this.duration*e/100,!1)},getSecsFromPercentage:function(e){return Math.floor(this.duration*e/100)},getDuration:function(){return this.mediaElement.duration},getPercentage:function(){return this.getPercentageFromSeconds(this.mediaElement.currentTime)},getPercentageFromSeconds:function(e){var t=e/this.duration*100;return Math.round(100*t)/100},seek:function(e){this.mediaElement.currentTime=t(this.duration,e)},seekBySeconds:function(e){this.mediaElement.currentTime=e}}};module.exports=radio;
},{"peaks/waveform/waveform.mixins":28}],21:[function(require,module,exports){
"use strict";function handleKeyEventGenerator(e){return function(t){var n=t.keyCode,r=t.type;if(["OBJECT","TEXTAREA","INPUT","SELECT","OPTION"].indexOf(t.target.nodeName)===-1)if([SPACE,TAB,LEFT_ARROW,RIGHT_ARROW].indexOf(t.type)>-1&&t.preventDefault(),"keydown"===r||"keypress"===r)switch(n){case SPACE:e.emit("kybrd_space");break;case TAB:e.emit("kybrd_tab")}else if("keyup"===r)switch(n){case LEFT_ARROW:t.shiftKey?e.emit("kybrd_shift_left"):e.emit("kybrd_left");break;case RIGHT_ARROW:e.shiftKey?e.emit("kybrd_shift_right"):e.emit("kybrd_right")}}}var SPACE=32,TAB=9,LEFT_ARROW=37,RIGHT_ARROW=39;module.exports={init:function(e){document.addEventListener("keydown",handleKeyEventGenerator(e)),document.addEventListener("keypress",handleKeyEventGenerator(e)),document.addEventListener("keyup",handleKeyEventGenerator(e))}};
},{}],22:[function(require,module,exports){
function WaveformOverview(e,t,a){function r(e,t){a.seeking||(i.playheadPixel=i.data.at_time(e),i.updateUi(i.playheadPixel))}var i=this;i.peaks=a,i.options=a.options,i.data=e,i.width=t.clientWidth,i.height=t.clientHeight||i.options.height,i.frameOffset=0,i.stage=new Konva.Stage({container:t,width:i.width,height:i.height}),i.waveformLayer=new Konva.Layer,i.background=new Konva.Rect({x:0,y:0,width:i.width,height:i.height}),i.waveformLayer.add(i.background),i.createWaveform(),i.createRefWaveform(),i.createUi();var o=function(){i.stage.off("mousemove mouseup"),a.seeking=!1};i.stage.on("mousedown",function(e){!e.target||e.target.attrs.draggable||e.target.parent.attrs.draggable||("mousedown"==e.type?(a.seeking=!0,a.emit("user_seek.overview",i.data.time(e.evt.layerX),e.evt.layerX),i.stage.on("mousemove",function(e){a.emit("user_scrub.overview",i.data.time(e.evt.layerX),e.evt.layerX)}),i.stage.on("mouseup",o)):o())}),a.on("player_time_update",r),a.on("user_seek.*",r),a.on("user_scrub.*",r),a.on("waveform_zoom_displaying",function(e,t){i.updateRefWaveform(e,t)}),a.on("resizeEndOverview",function(e,t){i.width=e,i.data=t,i.stage.setWidth(i.width),a.emit("overview_resized")})}var WaveformAxis=require("peaks/waveform/waveform.axis"),mixins=require("peaks/waveform/waveform.mixins"),Konva=require("konva");WaveformOverview.prototype.createWaveform=function(){var e=this;this.waveformShape=new Konva.Shape({fill:e.options.overviewWaveformColor,strokeWidth:0}),this.waveformShape.sceneFunc(mixins.waveformDrawFunction.bind(this.waveformShape,e)),this.waveformLayer.add(this.waveformShape),this.stage.add(this.waveformLayer)},WaveformOverview.prototype.createRefWaveform=function(){var e=this;this.refLayer=new Konva.Layer,this.refWaveformRect=new Konva.Rect({x:0,y:11,width:0,stroke:e.options.overviewHighlightRectangleColor,strokeWidth:1,height:this.height-22,fill:e.options.overviewHighlightRectangleColor,opacity:.3,cornerRadius:2}),this.refLayer.add(this.refWaveformRect),this.stage.add(this.refLayer)},WaveformOverview.prototype.createUi=function(){var e=this;this.playheadLine=new Konva.Line({points:[.5,0,.5,e.height],stroke:e.options.playheadColor,strokeWidth:1,x:0}),e.uiLayer=new Konva.Layer({index:100}),e.axis=new WaveformAxis(e),this.uiLayer.add(this.playheadLine),this.stage.add(this.uiLayer),this.uiLayer.moveToTop()},WaveformOverview.prototype.updateRefWaveform=function(e,t){if(isNaN(e))throw new Error("WaveformOverview#updateRefWaveform passed a time in that is not a number: "+e);if(isNaN(t))throw new Error("WaveformOverview#updateRefWaveform passed a time out that is not a number: "+t);var a=this,r=a.data.at_time(e),i=a.data.at_time(t);a.data.set_segment(r,i,"zoom"),a.refWaveformRect.setAttrs({x:a.data.segments.zoom.offset_start-a.data.offset_start,width:a.data.at_time(t)-a.data.at_time(e)}),a.refLayer.draw()},WaveformOverview.prototype.updateUi=function(e){if(isNaN(e))throw new Error("WaveformOverview#updateUi passed a value that is not a number: "+e);var t=this;t.playheadLine.setAttr("x",e),t.uiLayer.draw()},module.exports=WaveformOverview;
},{"konva":3,"peaks/waveform/waveform.axis":26,"peaks/waveform/waveform.mixins":28}],23:[function(require,module,exports){
function WaveformZoomView(e,a,t){var o=this;o.cur_scale=0,o.peaks=t,o.options=t.options,o.rootData=e,o.playing=!1,o.intermediateData=null,o.data=o.rootData.resample({scale:o.options.zoomLevels[t.zoom.getZoom()]}),o.playheadPixel=o.data.at_time(o.options.mediaElement.currentTime),o.pixelLength=o.data.adapter.length,o.frameOffset=0,o.width=a.clientWidth,o.height=a.clientHeight||o.options.height,o.data.offset(o.frameOffset,o.frameOffset+o.width),o.stage=new Konva.Stage({container:a,width:o.width,height:o.height}),o.zoomWaveformLayer=new Konva.Layer,o.uiLayer=new Konva.Layer,o.background=new Konva.Rect({x:0,y:0,width:o.width,height:o.height}),o.zoomWaveformLayer.add(o.background),o.axis=new WaveformAxis(o),o.createZoomWaveform(),o.createUi(),o.stage.on("mousedown",function(e){if(e.target&&!e.target.attrs.draggable&&!e.target.parent.attrs.draggable&&"mousedown"===e.type){var a,i,r=e.evt.layerX;t.seeking=!0,o.stage.on("mousemove",function(e){t.seeking=!1,a=e.evt.layerX>r?r-e.evt.layerX:1*(r-e.evt.layerX),r=e.evt.layerX,i=o.frameOffset+a,i=i<0?0:i>o.pixelLength-o.width?o.pixelLength-o.width:i,o.updateZoomWaveform(i)}),o.stage.on("mouseup",function(){t.seeking&&o.peaks.emit("user_seek.zoomview",o.data.time(o.frameOffset+r),o.frameOffset+r),o.stage.off("mousemove mouseup"),t.seeking=!1})}});var i=function(e,a){e=e||{withOffset:!0};var t=o.data.at_time(a);o.seekFrame(t,e.withOffset?Math.round(o.width/2):0),o.playing&&o.playFrom(a,t)};o.peaks.on("player_time_update",function(e){t.seeking||o.seekFrame(o.data.at_time(e))}),o.peaks.on("player_seek",i.bind(null,{withOffset:!0})),o.peaks.on("user_seek.*",i.bind(null,{withOffset:!0})),o.peaks.on("user_scrub.*",i.bind(null,{withOffset:!1})),o.peaks.on("player_play",function(e){o.playing=!0,o.playFrom(e,o.data.at_time(e))}),o.peaks.on("player_pause",function(e){o.playing=!1,o.playheadLineAnimation&&o.playheadLineAnimation.stop(),o.syncPlayhead(o.data.at_time(e))}),o.peaks.on("zoom.update",function(e,a){var t,i;if(!o.playing&&e!==a){if(o.data=o.rootData.resample({scale:e}),i={animated:AnimatedZoomAdapter,"static":StaticZoomAdapter},void 0===i[o.peaks.options.zoomAdapter])throw new Error("Invalid zoomAdapter: "+o.peaks.options.zoomAdapter);t=i[o.peaks.options.zoomAdapter].init(e,a,o),t.start()}}),o.peaks.on("window_resized",function(e,a){o.width=e,o.data=a,o.stage.setWidth(o.width),o.updateZoomWaveform(o.frameOffset),o.peaks.emit("zoomview_resized")});var r=function(e){var a=o.options.mediaElement.currentTime;a+=o.options.nudgeIncrement*e,o.seekFrame(o.data.at_time(a))};o.peaks.on("kybrd_left",r.bind(o,-1)),o.peaks.on("kybrd_right",r.bind(o,1)),o.peaks.on("kybrd_shift_left",r.bind(o,-10)),o.peaks.on("kybrd_shift_right",r.bind(o,10))}var WaveformAxis=require("peaks/waveform/waveform.axis"),mixins=require("peaks/waveform/waveform.mixins"),AnimatedZoomAdapter=require("peaks/views/zooms/animated"),StaticZoomAdapter=require("peaks/views/zooms/static"),Konva=require("konva");WaveformZoomView.prototype.createZoomWaveform=function(){var e=this;e.zoomWaveformShape=new Konva.Shape({fill:e.options.zoomWaveformColor,strokeWidth:0}),e.zoomWaveformShape.sceneFunc(mixins.waveformDrawFunction.bind(e.zoomWaveformShape,e)),e.zoomWaveformLayer.add(e.zoomWaveformShape),e.stage.add(e.zoomWaveformLayer),e.peaks.emit("waveform_zoom_displaying",0*e.data.seconds_per_pixel,e.width*e.data.seconds_per_pixel)},WaveformZoomView.prototype.createUi=function(){var e=this;e.zoomPlayheadLine=new Konva.Line({points:[.5,0,.5,e.height],stroke:e.options.playheadColor,strokeWidth:1}),e.zoomPlayheadText=new Konva.Text({x:2,y:12,text:"00:00:00",fontSize:11,fontFamily:"sans-serif",fill:e.options.playheadTextColor,align:"right"}),e.zoomPlayheadGroup=new Konva.Group({x:0,y:0}).add(e.zoomPlayheadLine).add(e.zoomPlayheadText),e.uiLayer.add(e.zoomPlayheadGroup),e.stage.add(e.uiLayer),e.zoomPlayheadGroup.moveToTop()},WaveformZoomView.prototype.updateZoomWaveform=function(e){if(isNaN(e))throw new Error("WaveformZoomView#updateZoomWaveform passed a pixel offset that is not a number: "+e);var a=this;a.pixelLength=a.data.adapter.length,a.pixelLength<a.width&&(e=0),e>a.pixelLength&&(e=a.pixelLength-a.width),e<0&&(e=0),a.frameOffset=e,a.data.offset(e,Math.min(e+a.width,a.pixelLength));var t=a.playheadPixel>=e&&a.playheadPixel<=e+a.width;if(t){var o=a.playheadPixel-e;a.zoomPlayheadGroup.show().setAttr("x",o),a.zoomPlayheadText.setText(mixins.niceTime(a.data.time(a.playheadPixel),!1))}else a.zoomPlayheadGroup.hide();a.uiLayer.draw(),a.zoomWaveformLayer.draw(),a.peaks.emit("waveform_zoom_displaying",e*a.data.seconds_per_pixel,(e+a.width)*a.data.seconds_per_pixel)},WaveformZoomView.prototype.playFrom=function(e,a){var t=this;t.playheadLineAnimation&&t.playheadLineAnimation.stop();var o=0,i=t.data.pixels_per_second;t.playheadLineAnimation=new Konva.Animation(function(e){var r=e.time,n=r/1e3,s=Math.round(a-t.frameOffset+i*(n-o));t.syncPlayhead(t.frameOffset+s)},t.uiLayer),t.playheadLineAnimation.start()},WaveformZoomView.prototype.newFrame=function(e){if(isNaN(e))throw new Error("WaveformZoomView#newFrame passed a frame offset that is not a number: "+e);var a=e+this.width;return a<this.data.adapter.length&&(this.frameOffset=a,this.updateZoomWaveform(a),!0)},WaveformZoomView.prototype.syncPlayhead=function(e){if(isNaN(e))throw new Error("WaveformZoomView#syncPlayhead passed a pixel index that is not a number: "+e);var a=this,t=e>=a.frameOffset&&e<=a.frameOffset+a.width;if(a.playheadPixel=e,t){var o=a.playheadPixel-a.frameOffset;a.zoomPlayheadGroup.show().setAttr("x",o),a.zoomPlayheadText.setText(mixins.niceTime(a.data.time(a.playheadPixel),!1))}else a.zoomPlayheadGroup.hide();a.uiLayer.draw()},WaveformZoomView.prototype.seekFrame=function(e,a){if(isNaN(e))throw new Error("WaveformZoomView#seekFrame passed a pixel index that is not a number: "+e);var t=this,o=t.data.adapter.length-t.width;e<t.data.offset_start?"backwards":"onwards";t.data.in_offset(e)||(t.frameOffset=e-Math.round(t.width/2),t.frameOffset<=0?t.frameOffset=0:t.frameOffset+t.width>=t.data.adapter.length&&(t.frameOffset=o)),t.syncPlayhead(e),t.updateZoomWaveform(t.frameOffset)},module.exports=WaveformZoomView;
},{"konva":3,"peaks/views/zooms/animated":24,"peaks/views/zooms/static":25,"peaks/waveform/waveform.axis":26,"peaks/waveform/waveform.mixins":28}],24:[function(require,module,exports){
var Konva=require("konva");module.exports={init:function(a,t,e){var r,i,o,n=e,s=n.peaks.time.getCurrentTime(),m=[],d=30;n.segmentLayer&&(n.segmentLayer.setVisible(!1),n.pointLayer.setVisible(!1)),t<a&&(d=15);for(var l=0;l<d;l++){var p=Math.round(t+(l+1)*(a-t)/d),u=n.width*p/n.rootData.adapter.sample_rate;if(s>=0&&s<=0+u/2)r=0,i=0;else if(s<=n.rootData.duration&&s>=n.rootData.duration-u/2)o=n.rootData.duration-u,r=o*n.rootData.adapter.sample_rate/t,i=o*n.rootData.adapter.sample_rate/p;else{var D=s*n.rootData.adapter.sample_rate/t;r=D-n.width/2;var h=s*n.rootData.adapter.sample_rate/p;i=h-n.width/2}r<0&&(r=0);var v=n.rootData.resample({scale:p,input_index:Math.floor(r),output_index:Math.floor(i),width:n.width});m.push(v),t=p}return new Konva.Animation(this.onFrameData(e,m),e)},onFrameData:function(a,t){var e=a;return e.intermediateData=null,function(a){t.length?(e.intermediateData=t.shift(),e.zoomWaveformLayer.draw()):(this.stop(),e.intermediateData=null,e.segmentLayer.setVisible(!0),e.pointLayer.setVisible(!0),e.seekFrame(e.data.at_time(e.peaks.time.getCurrentTime())))}}};
},{"konva":3}],25:[function(require,module,exports){
"use strict";module.exports={init:function(e,t,r){return{start:function(){r.segmentLayer.draw(),r.pointLayer.draw(),r.seekFrame(r.data.at_time(r.peaks.time.getCurrentTime()))}}}};
},{}],26:[function(require,module,exports){
function roundUpToNearest(t,e){var i=t%e;return 0===i?t:t+e-i}function WaveformAxis(t){this.view=t,this.axisShape=new Konva.Shape({fill:"rgba(38, 255, 161, 1)",strokeWidth:0,opacity:1}),this.axisShape.sceneFunc(this.axisDrawFunction.bind(this,t)),this.view.uiLayer.add(this.axisShape)}var mixins=require("peaks/waveform/waveform.mixins"),Konva=require("konva");WaveformAxis.prototype.getAxisLabelScale=function(){for(var t,e=1,i=[1,2,5,10,20,30],a=60,s=0;;){t=e*i[s];var r=this.view.data.at_time(t);if(!(r<a))break;++s==i.length&&(e*=60,s=0)}return t},WaveformAxis.prototype.axisDrawFunction=function(t,e){var i=t.data.time(t.frameOffset),a=10,s=this.getAxisLabelScale(),r=roundUpToNearest(i,s),o=r-i,n=this.view.data.at_time(o);e.setAttr("strokeStyle",this.view.options.axisGridlineColor),e.setAttr("lineWidth",1),e.setAttr("font","11px sans-serif"),e.setAttr("fillStyle",this.view.options.axisLabelColor),e.setAttr("textAlign","left"),e.setAttr("textBaseline","bottom");for(var h,v=r;h=n+this.view.data.at_time(v-r),!(h>=this.view.width);){e.beginPath(),e.moveTo(h+.5,0),e.lineTo(h+.5,0+a),e.moveTo(h+.5,this.view.height),e.lineTo(h+.5,this.view.height-a),e.stroke();var l=mixins.niceTime(v,!0),x=e._context.measureText(l).width,f=h-x/2,m=this.view.height-1-a;f>=0&&e.fillText(l,f,m),v+=s}},module.exports=WaveformAxis;
},{"konva":3,"peaks/waveform/waveform.mixins":28}],27:[function(require,module,exports){
var WaveformData=require("waveform-data"),WaveformOverview=require("peaks/views/waveform.overview"),WaveformZoomView=require("peaks/views/waveform.zoomview"),WaveformSegments=require("peaks/markers/waveform.segments"),WaveformPoints=require("peaks/markers/waveform.points"),isXhr2="withCredentials"in new XMLHttpRequest;module.exports=function(e){return{init:function(t){this.ui=t;var r=this;r.getRemoteData(e.options)},getRemoteData:function(e){var t=this,r=new XMLHttpRequest,i=null,a=null,o=null;if(e.dataUri){if("string"==typeof e.dataUri){var n={};n[e.dataUriDefaultFormat||"json"]=e.dataUri,e.dataUri=n}"object"==typeof e.dataUri&&["ArrayBuffer","JSON"].some(function(t){if(window[t])return a=t.toLowerCase(),i=e.dataUri[a],Boolean(i)})}if(!e.dataUri&&WaveformData.builders.webaudio.getAudioContext()&&(a="arraybuffer",i=e.mediaElement.currentSrc||e.mediaElement.src,o="webaudio"),!i)throw new Error("Unable to determine a compatible dataUri format for this browser.");if(r.open("GET",i,!0),isXhr2)try{r.responseType=a}catch(s){}r.onload=function(i){4===this.readyState&&(200===this.status?o?WaveformData.builders[o](i.target.response,e.waveformBuilderOptions,t.handleRemoteData.bind(t,null)):t.handleRemoteData(null,i.target,r):t.handleRemoteData(new Error("Unable to fetch remote data. HTTP Status "+this.status)))},r.send()},handleRemoteData:function(t,r,i){if(t)return e.emit("error",t);this.origWaveformData=null;try{this.origWaveformData=r instanceof WaveformData?r:WaveformData.create(r);var a=this.origWaveformData.resample(this.ui.player.clientWidth);this.waveformOverview=new WaveformOverview(a,this.ui.overview,e)}catch(o){return e.emit("error",o)}e.emit("waveformOverviewReady",this.waveformOverview),this.bindResize()},openZoomView:function(){var t=this;t.waveformZoomView=new WaveformZoomView(t.origWaveformData,t.ui.zoom,e),t.segments=new WaveformSegments(e),t.segments.init(),t.points=new WaveformPoints(e),t.points.init(),e.emit("waveformZoomReady",t.waveformZoomView)},bindResize:function(){var t=this;window.addEventListener("resize",function(){t.ui.overview.hidden=!0,t.ui.zoom.hidden=!0,t.resizeTimeoutId&&clearTimeout(t.resizeTimeoutId),t.resizeTimeoutId=setTimeout(function(){var r=t.ui.player.clientWidth,i=t.origWaveformData.resample(r);e.emit("resizeEndOverview",r,i),e.emit("window_resized",r,t.origWaveformData)},500)}),e.on("overview_resized",function(){t.ui.overview.removeAttribute("hidden")}),e.on("zoomview_resized",function(){t.ui.zoom.removeAttribute("hidden")}),e.on("user_seek.*",function(t){e.player.seekBySeconds(t)}),e.on("user_scrub.*",function(t){e.player.seekBySeconds(t)})}}};
...
function createPointHandle(e,t){return function(n,r,o,a,i,u){var f=e/2-10.5,l=10,d=20,h=.5,c=new Konva.Group({draggable:n,dragBoundFunc:function(e){return{x:e.x,y:this.getAbsolutePosition().y}}}).on("dragmove",function(e){a(r,o)});i&&c.on("dblclick",function(e){i(o)}),u&&c.on("dragend",function(e){u(o)});var s=-l,v=new Konva.Text({x:s,y:e/2-5,text:"",fontSize:10,fontFamily:"sans-serif",fill:"#000",textAlign:"center"});v.hide(),c.label=v;var g=new Konva.Rect({width:l,height:d,fill:t,x:h,y:f}),w=new Konva.Line({points:[0,0,0,e],stroke:t,strokeWidth:1,x:h,y:0});return g.on("mouseover",function(e){v.show(),v.setX(s-v.getWidth()),r.view.pointLayer.draw()}),g.on("mouseout",function(e){v.hide(),r.view.pointLayer.draw()}),c.add(g),c.add(w),c.add(v),c}}function drawWaveform(e,t,n,r,o,a){e.beginPath(),t.forEach(function(t,n){e.lineTo(r+n+.5,a(t)+.5)}),n.reverse().forEach(function(t,n){e.lineTo(r+(o-n)+.5,a(t)+.5)}),e.closePath()}function interpolateHeightGenerator(e){var t=256;return function(n){return e-(n+128)*e/t}}var Konva=require("konva"),createHandle=function(e,t,n){return function(r,o,a,i){var u=20,f=u/2,l=e/2-10.5,d=n?-f+.5:.5,h=new Konva.Group({draggable:r,dragBoundFunc:function(e){var t;return n?(t=o.outMarker.getX()-o.outMarker.getWidth(),e.x>t&&(e.x=t)):(t=o.inMarker.getX()+o.inMarker.getWidth(),e.x<t&&(e.x=t)),{x:e.x,y:this.getAbsolutePosition().y}}}).on("dragmove",function(e){i(o,a)}),c=n?-24:24,s=new Konva.Text({x:c,y:e/2-5,text:"",fontSize:10,fontFamily:"sans-serif",fill:"#000",textAlign:"center"});s.hide(),h.label=s;var v=new Konva.Rect({width:f,height:u,fill:t,stroke:t,strokeWidth:1,x:d,y:l}),g=new Konva.Line({points:[.5,0,.5,e],strokeWidth:1,stroke:t,x:0,y:0});return v.on("mouseover",function(e){n&&s.setX(c-s.getWidth()),s.show(),o.view.segmentLayer.draw()}),v.on("mouseout",function(e){s.hide(),o.view.segmentLayer.draw()}),h.add(s),h.add(g),h.add(v),h}};module.exports={interpolateHeight:interpolateHeightGenerator,drawWaveform:drawWaveform,waveformDrawFunction:function(e,t){var n=e.intermediateData||e.data,r=interpolateHeightGenerator(e.height),o=n.offset_length;drawWaveform(t,n.min,n.max,0,o,r),t.fillStrokeShape(this)},waveformOverviewMarkerDrawFunction:function(e,t,n){t.waveformShape.setPoints([e,0,e,n.height])},niceTime:function(e,t){var n,r,o,a,i=[];n=Math.floor(e%1*100),r=Math.floor(e),o=Math.floor(r/60),a=Math.floor(o/60),a>0&&i.push(a),i.push(o%60),i.push(r%60);for(var u=0;u<i.length;u++){var f=i[u];f<10?i[u]="0"+f:i[u]=f}return i=i.join(":"),t||(n<10&&(n="0"+n),i+="."+n),i},defaultInMarker:function(e){return createHandle(e.height,e.outMarkerColor,!0)},defaultOutMarker:function(e){return createHandle(e.height,e.outMarkerColor,!1)},defaultPointMarker:function(e){return createPointHandle(e.height,e.pointMarkerColor)},defaultSegmentLabelDraw:function(e){return function(e,t){return new Konva.Text({x:12,y:12,text:t.labelText,fontSize:12,fontFamily:"Arial, sans-serif",fill:"#000",textAlign:"center"})}}};
},{"konva":3}]},{},[15])(15)
});
